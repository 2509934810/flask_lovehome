...
from pip.exceptions import InstallationError, InvalidWheelFilename, UnsupportedWheel
...
class WheelCache(object):
    ...
    def cached_wheel(self, link, package_name):
        return cached_wheel(self._cache_dir, link, self._format_control, package_name)
...
class WheelBuilder(object):
    ...
    def __init__(
        self, requirement_set, finder, build_options=None, global_options=None
    ):
            ...
            if req.is_wheel:
                ...
                if autobuilding:
                    ...
                    if "binary" not in pip.index.fmt_ctl_formats(
                        self.finder.format_control, canonicalize_name(req.name)
                    ):
                        logger.info(
