...
class InstallRequirement(object):
    ...
    def from_line(
        ...
        if extras:
            res.extras = _safe_extras(Requirement("placeholder" + extras).extras)
    ...
    def build_location(self, build_dir):
        ...
        if self.req is None:
            ...
            # is returned.
            self._temp_build_dir = os.path.realpath(tempfile.mkdtemp("-build", "pip-"))
    ...
    def run_egg_info(self):
        ...
        if not self.req:
            ...
            self.req = Requirement(
                "".join([self.pkg_info()["Name"], op, self.pkg_info()["Version"],])
            )
    ...
    def assert_source_matches_version(self):
        ...
        if self.req.specifier and version not in self.req.specifier:
            logger.warning(
                "Requested %s, but installing version %s", self, self.installed_version,
            )
        else:
            logger.debug(
