...
def unpack_http_url(link, location, download_dir=None, session=None, hashes=None):
    if session is None:
        raise TypeError(
    ...
    if already_downloaded_path:
        ...
        from_path, content_type = _download_http_url(link, session, temp_dir, hashes)
...
def unpack_url(
    link, location, download_dir=None, only_download=False, session=None, hashes=None
):
    """Unpack link.
