...
#bottom{margin-top: 80px; height: 50px; line-height: 50px; background-color:lightseagreen; position: relative;}
#bottom p {float: left;}
#bottom a {float: right; margin-left: 20px; color:black;}
